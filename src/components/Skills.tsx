...
export default function Skills() {
    return (
        <section id="skills" className="py-20 md:py-24 px-4 max-w-5xl mx-auto">
            <h2 className="text-2xl md:text-3xl font-bold mb-12 text-center text-accent-ice">Technical Toolkit</h2>
